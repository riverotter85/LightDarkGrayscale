...
CudaImage *createCudaImage(string inputImage) {
    ...
    uchar *bright    = (uchar *) malloc(sizeof(uchar) * rows * cols);
    uchar *dark      = (uchar *) malloc(sizeof(uchar) * rows * cols);
    uchar *grayscale = (uchar *) malloc(sizeof(uchar) * rows * cols);
    ...
    cudaImage->bright    = bright;
    cudaImage->dark      = dark;
    cudaImage->grayscale = grayscale;
...
tupe<uchar *, uchar *, uchar *, uchar *, uchar *, uchar *> allocateDeviceMemory(int rows, int cols) {
